# /users/hbrun/onlineTest/firstCollisions2015/reRun50nsFrozenMuons/V6 (CMSSW_7_4_6)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/hbrun/onlineTest/firstCollisions2015/reRun50nsFrozenMuons/V6')
)
...
process.hltMuonEcalPFClusterIsoForMuons = cms.EDProducer( "MuonHLTEcalPFClusterIsolationProducer",
    ...
    effectiveAreaBarrel = cms.double( 0.1447 ),
    ...
    effectiveAreaEndcap = cms.double( 0.0858 ),
...
process.hltMuonHcalPFClusterIsoForMuons = cms.EDProducer( "MuonHLTHcalPFClusterIsolationProducer",
    ...
    drMax = cms.double( 0.3 ),
    effectiveAreaBarrel = cms.double( 0.0652 ),
    energyBarrel = cms.double( 0.0 ),
    effectiveAreaEndcap = cms.double( 0.132 ),
    drVetoEndcap = cms.double( 0.0 ),
    rhoMax = cms.double( 9.9999999E7 ),
...
process.hltL3crIsoL1sMu16L1f0L2f10QL3f20QL3trkIsoFiltered0p09 = cms.EDFilter( "HLTMuonIsoFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL3fL1sMu16L1f0L2f10QL3Filtered20Q" ),
    MinN = cms.int32( 1 ),
    IsolatorPSet = cms.PSet(  ),
    CandTag = cms.InputTag( "hltL3MuonCandidates" ),
    DepTag = cms.VInputTag( 'hltMuonTkRelIsolationCut0p09Map' )
)
process.hltPreTkMu20 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.HLTMu20IsolationSequence = cms.Sequence( process.HLTL3muonEcalPFisorecoSequenceNoBoolsForMuons + process.HLTL3muonHcalPFisorecoSequenceNoBoolsForMuons + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltMuonTkRelIsolationCut0p09Map )
...
process.HLT_Mu20_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu16 + process.hltPreMu20 + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered10Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16L1f0L2f10QL3Filtered20Q + process.HLTEndSequence )
...
process.HLT_TkMu20_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu16 + process.hltPreTkMu20 + process.hltL1fL1sMu16L1Filtered0 + process.HLTMuonLocalRecoSequence + process.HLTHighPt20TrackerMuonSequence + process.hltL3fL1sMu16f0TkFiltered20Q + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_ZeroBias_v1, process.HLT_L1SingleMu16_v1, process.HLT_L2Mu10_v1, process.HLT_Mu20_v1, process.HLT_IsoMu20_v2, process.HLT_TkMu20_v2, process.HLTriggerFinalPath ))
...
process.runL2seed = cms.EDAnalyzer('HLTmuonRecoAnalyzer',
                                   isMC                             = cms.bool(False),
                                   L2muonsCollection = cms.InputTag("hltL2MuonCandidates","","HLTfancy"),
                                   L3muonsCollection = cms.InputTag("hltL3MuonCandidates","","HLTfancy"),
                                   TKmuonsCollection = cms.InputTag("hltHighPtTkMuons","","HLTfancy"),
                                   BeamSpot = cms.InputTag("hltOnlineBeamSpot","","HLTfancy"),
                                   MuonRecHitBuilder = cms.string("MuonRecHitBuilder"),
                                   pathsToSave = cms.vstring("HLT_ZeroBias_v",
                                                             "HLT_L1SingleMu16_v",
                                                             "HLT_L2Mu10_v",
                                                             "HLT_Mu20_v",
                                                             "HLT_IsoMu20_v",
...
process.triggerResultsFilter.triggerConditions = cms.vstring("HLT_ZeroBias_v*","HLT_L1SingleMu16_v*","HLT_L2Mu10_v*","HLT_Mu20_v*","HLT_TkMu20_v*")
process.triggerResultsFilter.l1tResults = ''
process.triggerResultsFilter.throw = False
process.triggerResultsFilter.hltResults = cms.InputTag( "TriggerResults", "", "HLT" )

#process.triggerResultsFilterNew = process.triggerResultsFilter.clone(
#                                                                     triggerConditions = cms.vstring("HLT_L1SingleMu16_v*"),
#                                                                     hltResults = cms.InputTag( "TriggerResults", "", "HLTfancy" )
#                                                                     )

process.load("Configuration.StandardSequences.RawToDigi_Data_cff")
process.runLumi = cms.Path(process.scalersRawToDigi)
process.runAna = cms.EndPath(process.triggerResultsFilter*process.runL2seed)
# Schedule definition
process.schedule = cms.Schedule(process.runLumi)
process.schedule.extend(process.HLTSchedule)
#process.schedule = cms.Schedule(process.HLTSchedule)
process.schedule.extend([process.runAna])
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '74X_dataRun2_HLTValidation_Run2015B_v0')#auto:run2_hlt_GRun')
...
process.l1GtTriggerMenuXml = cms.ESProducer("L1GtTriggerMenuXmlProducer",
  ...
  DefXmlFile = cms.string('L1Menu_Collisions2015_50nsGct_v2_L1T_Scales_20141121.xml'),
...
_customInfo['inputFile' ]=  ['/store/data/Run2015A/ZeroBias/RAW/v1/000/248/038/00000/F87B01FE-0513-E511-9CB1-02163E0133D0.root']
