...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/tmp/hbrun/theRAWfile.root',
    ),
...
process.triggerResultsFilter.triggerConditions = cms.vstring("HLT_ZeroBias_v*")
...
#process.runAna = cms.EndPath(process.triggerResultsFilter*process.triggerResultsFilterNew*process.runL2seed)
process.runAna = cms.EndPath(process.runL2seed)
# Schedule definition
process.schedule = cms.Schedule(process.runMix)
...
_customInfo['inputFile' ]=  ['file:/tmp/hbrun/theRAWfile.root']
